    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Kategori Dokumen</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Edit Kategori Dokumen</h1>
                <p class="mb-0">Form untuk mengubah data kategori dokumen.</p>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                <div class="alert alert-info">
                                    ...
                                    <span class="badge bg-info">{{ $kategori->dokumenHukum->count() }} dokumen</span>
                                    yang terkait.
                                </div>
                            </div>
                        </div>
